<template>
	...
	<div class="container" :style='{"minHeight":"100vh","width":"100%","alignItems":"center","background":"url(http://codegen.caihongy.cn/20240201/16ba3d6813174f3ca7315ed484ce0d90.png) center center/100% 100% no-repeat","justifyContent":"center","display":"flex"}'>
		<el-form class='rgs-form' v-if="pageFlag=='register'" :style='{"padding":"40px 20px","boxShadow":"0px 4px 10px 0px rgba(0,0,0,0.3)","margin":"0","borderRadius":"30px","flexWrap":"wrap","background":"#fff","display":"flex","width":"44%","height":"auto"}' ref="registerForm" :model="registerForm" :rules="rules">
			...
			<div v-if="true" :style='{"margin":"0 0 10px 0","color":"#000","textAlign":"center","width":"100%","lineHeight":"44px","fontSize":"30px","textShadow":"none","fontWeight":"bold"}'>茶道系统注册</p></div>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="zhanghao">
				<div v-if="true" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","background":"none"}' :class="changeRules('zhanghao')?'required':''">账号：</div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="mima">
				<div v-if="true" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","background":"none"}' :class="changeRules('mima')?'required':''">密码：</div>
				<el-input v-model="registerForm.mima" type="password" placeholder="请输入密码" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="mima2">
				<div v-if="true" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","background":"none"}' :class="changeRules('mima')?'required':''">确认密码：</div>
				<el-input v-model="registerForm.mima2" type="password" placeholder="请再次输入密码" />
			</el-form-item>
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="xingming">
				<div v-if="true" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","background":"none"}' :class="changeRules('xingming')?'required':''">姓名：</div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="xingbie">
				<div v-if="true" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","background":"none"}' :class="changeRules('xingbie')?'required':''">性别：</div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="shouji">
				<div v-if="true" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","background":"none"}' :class="changeRules('shouji')?'required':''">手机：</div>
			...
			<el-form-item :style='{"width":"80%","padding":"0","margin":"0 auto 15px","height":"auto"}' v-if="tableName=='yonghu'" prop="touxiang">
				<div v-if="true" :style='{"width":"110px","lineHeight":"44px","fontSize":"14px","color":"#000","background":"none"}' :class="changeRules('touxiang')?'required':''">头像：</div>
                <file-upload
					tip="点击上传头像"
					action="file/upload"
					:limit="1"
			...
			<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","boxShadow":"none","margin":"20px auto 5px","color":"#000","display":"block","outline":"none","borderRadius":"5px","background":"linear-gradient(90deg, #5EE4EC 0%, #FFDFA6 100%)","width":"80%","fontSize":"24px","fontWeight":"bold","height":"60px"}' type="primary" @click="submitForm('registerForm')">注册</el-button>
			...
			<router-link :style='{"cursor":"pointer","padding":"10px 10%","color":"rgba(159, 159, 159, 1)","display":"block","lineHeight":"1","fontSize":"14px","textDecoration":"none"}' to="/login">已有账户登录</router-link>
          ...
          if (valid) {
            var url=this.tableName+"/register";
               ...
               if(`yonghu` == this.tableName && this.registerForm.mima!=this.registerForm.mima2) {
				...
				if((!this.registerForm.shouji) && `yonghu` == this.tableName){
...
<style rel="stylesheet/scss" lang="scss" scoped>
	.container {
		position: relative;
		background: url(http://codegen.caihongy.cn/20240201/16ba3d6813174f3ca7315ed484ce0d90.png) center center/100% 100% no-repeat;
